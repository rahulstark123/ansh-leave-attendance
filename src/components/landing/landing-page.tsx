...
import { ANSH_ECOSYSTEM_APPS as ecosystemApps } from "@/lib/ansh-ecosystem-apps";
          ...
          <div className="lg:col-span-7 space-y-7 text-left">
            ...
            <div className="pt-6 border-t border-zinc-200/80 dark:border-white/5">
              <p className={`text-[10px] font-bold uppercase tracking-wider ${LANDING_MUTED}`}>
                Built for Bharat, Ready for the World — encouraging{" "}
      ...
      <footer className={LANDING_FOOTER}>
        <div className={`${PAGE_SHELL} space-y-12`}>
          ...
          <div className="text-center select-none border-b border-zinc-200/80 pb-12 overflow-hidden dark:border-white/5">
            ...
            <p className="ansh-shimmer-tagline mx-auto mt-3 max-w-5xl px-4 text-xl font-extrabold tracking-[0.08em] sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
              <span className="ansh-shimmer-base">Built for Bharat, Ready for the World</span>
              <span className="ansh-shimmer-overlay" aria-hidden="true">
